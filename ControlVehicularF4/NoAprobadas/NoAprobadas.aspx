<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoAprobadas.aspx.cs" Inherits="ControlVehicularF4.NoAprobadas.NoAprobadas" %>
                                        ...
                                        <div class="panel-body" style="padding: 15px;">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-group input-group-sm">
                                                        <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-calendar"></i>PUNTOS CRITICOS</span>
                                             ...
                                             <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-group input-group-sm">
                                                        <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-calendar"></i>EVIDENCIA</span>
                                                     
                                                        
                                                         <asp:TextBox ID="TextBox1"  CssClass="form-control"  Width="200"  runat="server"></asp:TextBox><asp:Button ID="Button1"   CssClass="form-control" runat="server" Text="Button" />

                                                         <%--<button id="Button1" runat="server" type="submit" wi class="btn btn-primary btn-block btn-flat">APROBAR</button>--%>
                                             ...
                                             <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-group input-group-sm">
                                                        <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-calendar"></i>COMENTARIOS</span>
                                                     
                                                        <asp:TextBox ID="txtcomentarios"  CssClass="form-control" TextMode="MultiLine" Height="100" runat="server"></asp:TextBox>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-group input-group-sm">
                                                        <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-calendar"></i>GRABAR CAMBIOS</span>
                                                        <%-- <input id="KilometrajeManto" type="text" disabled="" class="form-control" placeholder="" aria-describedby="sizing-addon1">--%>
                                                        <%--<asp:Button CssClass="btn btn-primary" ID="btnGrabar" runat="server" Text="Grabar"></asp:Button>--%>
                                                        <div class="col-md-4">
                                                            <button id="btlogin" runat="server" type="submit" class="btn btn-primary btn-block btn-flat">APROBAR</button>
                                                        </div>
